...
{
    public TextMesh screenTextPublic;
    TextMesh screenText;
    ...
    public void HandleRewardBasedVideoClosed(object sender, EventArgs args)
    {
        ...
        if (screenTextPublic.gameObject != null)
        {
            screenTextPublic.text = "(public) Video Closed";
        }
        if (screenText.gameObject != null)
        {
            screenText.text = "Video Closed";
        }
    }
    ...
    public void HandleRewardBasedVideoRewarded(object sender, Reward args)
    {
        ...
        if (screenTextPublic.gameObject != null)
        {
            screenTextPublic.text = "(public) Rewarded";
        }
        if (screenText.gameObject != null)
        {
            screenText.text = "Rewarded";
        }
    }
